    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{route('ruangkelas.create')}}" class="btn btn-primary">+ Tambah Data</a>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
                    ...
                    <tbody>
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('ruangkelas.edit', $item->id)}}">
                                    ...
                                    <form id="delete-form-{{ $item->id }}" action="{{ route('ruangkelas.destroy', $item->id) }}"
